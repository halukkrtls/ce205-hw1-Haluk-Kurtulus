...
/// <summary>
/// to add a piece to a sparse matrix
/// </summary>
/// <param name="matrix"></param>
/// <param name="row"></param>
/// <param name="column"></param>
...
/// <summary>
/// to remove a sparse matrix item
/// </summary>
/// <param name="matrix"></param>
/// <param name="row"></param>
/// <param name="column"></param>
...
/// <summary>
/// the number of entries in the sparse matrix
/// </summary>
/// <param name="matrix"></param>
/// <returns></returns>
